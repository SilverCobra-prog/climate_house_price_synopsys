...
# region forecast
precipitation_data_autauga_jan["Lag_1"] = precipitation_data_autauga_jan["Jan"].shift(1)

X = precipitation_data_autauga_jan.loc[:, ["Lag_1"]]
X.dropna(inplace=True)  # drop missing values in the feature set
y = precipitation_data_autauga_jan.loc[:, "Jan"]  # create the target
